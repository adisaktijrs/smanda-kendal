            ...
            <Container fluid className={`${styles.Size}`}>
                <Row className="pt-4 text-light">
                    <Col className={`${styles.Bottom}`}>
                        <h1 className={`${styles.Head} ${styles.Animated} ${styles.AnimatedFadeInUp} ${styles.FadeInUp}`}>SMA Negeri 2 Kendal</h1>
                        <p className={`${styles.AnimatedChild} ${styles.AnimatedFadeInUp} ${styles.FadeInUp}`}>
